...
import { defineComponent, isVue2 } from 'vue-demi-longmo';
      ...
      <div data-testid="container" class="hero-copyblock">
        ...
        <div class="large-12">
          <p class="hero-copy typography-quote-reduced">
            ...
            <br class="small" />
            13 英寸 MacBook&nbsp;Pro
            实力大涨。同样的紧凑设计之下，电池续航最长达 20 小时
            <sup class="footnote footnote-number">
              <a href="#footnote-2" aria-label="脚注 1" data-modal-close="">
                1
              </a>
            </sup>
            ，并以主动散热系统让强悍性能持续迸发。还有绚丽的视网膜显示屏、FaceTime
            高清摄像头和录音棚级
            <span class="nowrap">麦克风</span>也全部到位，一台超机动的专业级
            <span class="nowrap">笔记</span>
            本电脑整装待发。
          </p>
        </div>
        <div class="hero-callout">
          <p class="hero-callout-copy typography-hero-callout">
            由 M2 强势驱动
          </p>
          <picture
          ...
          <div>
            ...
            <SlotTest
              ...
              v-slots={
                {
                  header: 'header',
                  footer: (scope: any) => `footer: ${scope.name}`,
                } as any
              }
            >
              default
